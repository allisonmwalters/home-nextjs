...
export default function Home() {
  return (
    <main className="flex items-center justify-center min-h-screen bg-gray-50">
      <div className="container mx-auto p-4 relative">
        <div className="bg-white border-2 border-purple-100 rounded-lg p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex flex-col justify-center">
            <h1 className={`text-4xl ${styles.text_blue} font-bold mb-4`}>Welcome</h1>
      ...
      <div className={`${styles.bg_blue} hidden md:block absolute top-0 right-0 bottom-0 left-2/3 z-0`}></div>
    </main >
  );
}